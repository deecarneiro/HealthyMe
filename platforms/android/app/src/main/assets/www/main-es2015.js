...
const routes = [
    ...
    {
        path: 'patient-list',
        loadChildren: () => __webpack_require__.e(/*! import() | patient-list-patient-list-module */ "patient-list-patient-list-module").then(__webpack_require__.bind(null, /*! ./patient-list/patient-list.module */ "./src/app/patient-list/patient-list.module.ts")).then(m => m.PatientListPageModule)
    },
    {
        path: 'professional-list',
        loadChildren: () => __webpack_require__.e(/*! import() | professional-list-professional-list-module */ "professional-list-professional-list-module").then(__webpack_require__.bind(null, /*! ./professional-list/professional-list.module */ "./src/app/professional-list/professional-list.module.ts")).then(m => m.ProfessionalListPageModule)
    },
    {
        path: 'create-user',
        loadChildren: () => __webpack_require__.e(/*! import() | create-user-create-user-module */ "create-user-create-user-module").then(__webpack_require__.bind(null, /*! ./create-user/create-user.module */ "./src/app/create-user/create-user.module.ts")).then(m => m.CreateUserPageModule)
    },
    {
...
module.exports = __webpack_require__(/*! /home/deecarneiro/Área de Trabalho/Environment Ionic 5/williarts/HealthyMe/src/main.ts */"./src/main.ts");
